package com.example.spring.practice.metadata;
...
//    }
    ...
    boolean isDriverCompatible(String driverClass) {
        return (driverClass != null
                &&
//                (driverClass.equals(getDriverClassName()) ||
                driverClass.equals(this.alternativeDriverClass));
    }
